...
EVALUATION_SYSTEM_ROLE_REV_3_0 = {
    'role': "system", 
    'content': "Task description:\nEvaluate how relevant a text passage is to answer a question, indicating a score from 0 to 3 for the passage relevance.\n\nEvaluation criteria:\npassage completeness: how complete is the passage to answer the question; complete passage provides all the requested information, including examples when appropriate.\npassage adequacy: how clearly the passage answers to the question; adequate passage includes along with the answer relevant information which clarifies or enriches the answer.\n\nEvaluation Steps:\n\n1. Read the question carefully: Understand what information is being asked for in the question. This will help you to evaluate the passage's adequacy in answering the question.\n\n2. Read the passage: Read the passage thoroughly to understand its content. Make sure to pay attention to the details and the overall context of the passage.\n\n3. Evaluate passage completeness: Check if the passage provides all the information requested in the question. If the question asks for examples, check if the passage provides them. If the passage provides all the requested information, it is complete.\n\n4. Evaluate passage adequacy: Check how clearly the passage answers the question. An adequate passage should not only provide the answer but also include relevant information that clarifies or enriches the answer.\n\n5. Score the passage: Based on your evaluation, score the passage on a scale of 0 to 3.\nScore 0: The passage does not answer the question at all.\nScore 1: The passage provides some information related to the question, but it is not complete or clear.\nScore 2: The passage provides a complete answer to the question, but it lacks clarity or additional relevant information.\nScore 3: The passage provides a complete and clear answer to the question, including relevant additional information.\nExpected JSON output:\n{\"Razão\": \"<>\", \"Pontuação\":  <>}"
}
...
EVALUATION_SYSTEM_ROLE=EVALUATION_SYSTEM_ROLE_REV_3_0
